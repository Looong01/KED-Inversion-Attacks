...
'''
save_img_dir = "./Checkpoints/new_celeba_gan/binaryGAN/imgs_celeba_gan"
save_model_dir= "./Checkpoints/new_celeba_gan/binaryGAN/"
os.makedirs(save_model_dir, exist_ok=True)
os.makedirs(save_img_dir, exist_ok=True)

dataset_name = "celeba"

log_path = "./Checkpoints/new_celeba_gan/binaryGAN/attack_logs"
...
if __name__ == "__main__":
    ...
    '''
    Train the model with dynamic batch size and learning rate
    '''
    for i in range(1, 4):
        if i == 1:
            batch_size = 64*1
