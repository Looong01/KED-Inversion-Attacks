...
if __name__ == "__main__":
    ...
    '''
    Create the parser (super parameters)
    '''
    ...
    if args.improved_flag == True:
        ...
        path_G = './Checkpoints/GAN_Checkpoints/improved_celeba_G.tar'
        path_D = './Checkpoints/GAN_Checkpoints/improved_celeba_D.tar'
    else:
        D = DGWGAN(3)
        path_G = './Checkpoints/GAN_Checkpoints/celeba_G.tar'
        path_D = './Checkpoints/GAN_Checkpoints/celeba_D.tar'
    ...
    path_E = './Checkpoints/Target_Model_Checkpoints/FaceNet_95.88.tar'
