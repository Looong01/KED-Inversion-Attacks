...
# mnist_img_path = "./Datasets/MNIST_data/t10k-images.idx3-ubyte"
cifar_path = "./Datasets/cifar-10-python"


# cifar_img_path = "./Datasets/CIFAR_imgs"
...
def load_attri(file_path):
    ...
    '''
    data_path = sorted(glob.glob('./Datasets/Celeba/Img/img_align_celeba_png/*.png'))
    print(len(data_path))
    # get label
    att_path = './Datasets/Celeba/Anno/list_attr_celeba.txt'
